"""Run a standalone replay server over ZMQ for remote deployment clients."""
...
from in_hand_rotation_mjlab.policy_server.zmq_transport import (
  ReplayZmqServer,
  ZmqServerConfig,
)
...
class ReplayServerZmqCliConfig:
  trajectory_file: str
